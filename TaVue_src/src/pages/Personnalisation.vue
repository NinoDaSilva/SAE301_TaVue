<script setup lang="">
  ...
  let selectedForme = ref()

  let Noir = ref("#171717")
  let Gris = ref("#616161")
  let Rouge = ref("#F65C50")
  let Bleu = ref("#504DD8")

  let selectedColor_cadre = ref()
  let selectedColor_verres = ref()
  let selectedColor_branches = ref()
...
<template>
  ...
  <div class="mx-5 lg:mr-20 lg:ml-10 lg:dispo items-center">
    <div class="mx-[8%] max-lg:mt-14 max-lg:ml-16">
      ...
      <div class="font-medium mt-5 lg:mt-20 lg:ml-10 text-base lg:text-lg font-Khand">Prix de vente :  89.99€</div>
    </div>
    
    <div class="space-y-8 md:ml-20 mx-auto my-14 max-w-[500px]">
      <div>
        ...
        <div class="mt-2 flex gap-4 items-center">
          <Btn class="btn-selected" text="Rectangulaire" v-bind:class="{ 'selected': selectedForme === 'Rectangulaire' }" @click="selectedForme = 'Rectangulaire'"/>
          <Btn class="btn-selected" text="Ronde" v-bind:class="{ 'selected': selectedForme === 'Ronde' }" @click="selectedForme = 'Ronde'"/>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex gap-4 mt-1">
          <Btn class="btn-selected" text="Plastique" v-bind:class="{ 'selected': selectedMaterial_cadre === 'Plastique' }"
            @click="selectedMaterial_cadre = 'Plastique'"/>
          <Btn class="btn-selected" text="Bois" v-bind:class="{ 'selected': selectedMaterial_cadre === 'Bois' }"
            @click="selectedMaterial_cadre = 'Bois'"/>
          <Btn class="btn-selected" text="Métal" v-bind:class="{ 'selected': selectedMaterial_cadre === 'Métal' }"
      ...
      <div>
        ...
        <div class="flex gap-4 mt-1">
          <Btn class="btn-selected" text="Polycarbonate" v-bind:class="{ 'selected': selectedMaterial_verre === 'Polycarbonate' }"
            @click="selectedMaterial_verre = 'Polycarbonate'"/>
          <Btn class="btn-selected" text="Verre" v-bind:class="{ 'selected': selectedMaterial_verre === 'Verre' }"
      ...
      <div>
        ...
        <div class="flex gap-4 mt-1">
          <Btn class="btn-selected" text="Plastique" v-bind:class="{ 'selected': selectedMaterial_branche === 'Plastique' }"
            @click="selectedMaterial_branche = 'Plastique'"/>
          <Btn class="btn-selected" text="Bois" v-bind:class="{ 'selected': selectedMaterial_branche === 'Bois' }"
            @click="selectedMaterial_branche = 'Bois'"/>
          <Btn class="btn-selected" text="Métal" v-bind:class="{ 'selected': selectedMaterial_branche === 'Métal' }"
      ...
      <Btn class="sm:w-80 h-14" text="Enregistrer mes choix" @click="createLunettes()"/>
    </div>
  </div>
